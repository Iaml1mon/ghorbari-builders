      ...
      <section className="relative bg-gradient-to-br from-orange-50 to-blue-50 mobile-hero">
        <div className="max-w-7xl mx-auto mobile-container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            {/* Hero Content */}
            <div className="space-y-6 lg:space-y-8 mobile-slide-in">
              <div className="space-y-4">
                <h1 className="mobile-heading font-bold text-gray-900 leading-tight">
                  {t.hero.name}
                </h1>
                <h2 className="mobile-subheading text-orange-600 font-semibold">
                  {t.hero.title}
                </h2>
...
<<<<<<< HEAD
            <div className="relative mobile-fade-in">
              <img 
                ...
                alt="Md Asraful" 
                className="w-full h-auto aspect-square sm:aspect-[4/5] object-cover rounded-2xl shadow-2xl mobile-image" 
              />
              {/* Floating elements */}
